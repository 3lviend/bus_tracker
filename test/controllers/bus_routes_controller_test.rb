...
class BusRoutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus_route" do
    assert_difference('BusRoute.count') do
      post bus_routes_url, params: { bus_route: { code: @bus_route.code, display_name: @bus_route.display_name } }
    end
  ...
  test "should update bus_route" do
    patch bus_route_url(@bus_route), params: { bus_route: { code: @bus_route.code, display_name: @bus_route.display_name } }
