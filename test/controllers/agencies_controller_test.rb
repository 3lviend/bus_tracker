...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { code: @agency.code, display_name: @agency.display_name } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { code: @agency.code, display_name: @agency.display_name } }
